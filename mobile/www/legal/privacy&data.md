...
| Listening stats (play counts, listened seconds, skips, artist/album opens) | Feeds the recommendation system and MIX system - this one's opt-out. |
...
Full breakdown of the stats specifically (what counts, the safety limits, how to manage it) lives in "data-and-privacy.md" (on GitHub)
...
Since everything about this project is open source, you can always check the commit history on GitHub, on this exact file to see what changed and when. That's a receipt a normal privacy policy PDF can never give you lol.

---

## Questions?

Open an Issue on GitHub and ask. I'd rather answer a "wait, what does Y actually do" question directly than have you guess.
