...
function updateMediaSessionPlaybackState() {
	...
	// same as updateNativePlayingState: keep the session "playing" across the brief
	// auto-advance gap instead of flipping to paused (which weakens the media contract).
...
function updateMediaSessionPositionState(force = false) {
	...
	try {
		...
		// a live stream has no finite duration (Infinity) - skip position state entirely
